...
public class PreferencesUtil {
    ...
    public static String PREFERENCE_NAME = "affectionfornurse";
    ...
    public static boolean saveList(Context context, String tag, List<String> list) {
        SharedPreferences settings = context.getSharedPreferences(PREFERENCE_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = settings.edit();
    ...
    public static boolean saveArrayList(Context context, String tag, ArrayList<String> arrayList) {
        SharedPreferences settings = context.getSharedPreferences(PREFERENCE_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = settings.edit();
